  ...
  <div class="card-body">
    <form action="{{route('jawaban.create')}}" method="post" accept-charset="utf-8">
      <div class="form-group">
        <label>Isi</label>
        <textarea class="form-control" value="{{$jawaban->isi}}" name="isi"></textarea>
      </div>
      <div class="form-group">
        <label>Jawaban Benar</label>
        <input type="radio" @if($jawaban->jawaban_benar == "true") selected @endif name="jawaban_benar">True<br>
        <input type="radio" @if($jawaban->jawaban_benar == "false") selected @endif name="jawaban_benar">False
      </div>
      <div class="form-group">
